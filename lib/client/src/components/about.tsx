        ...
        <ul>
          <li className="top-buffer">
            ...
            <ul className="top-buffer">
              <li>
                <h4>
                  components/members/actions/...:{" "}
                  <small>Isolated members component actions</small>
                </h4>
              </li>
              <li>
                <h4>
                  components/member/actions/...:{" "}
                  <small>Isolated member component actions</small>
                </h4>
              </li>
            </ul>
          </li>
          <li className="top-buffer">
            ...
            <ul className="top-buffer">
              ...
              <li>
                <h4>
                  reducers/memberErrors.ts:{" "}
                  <small>Manage memberErrors state</small>
                </h4>
              </li>
            </ul>
          </li>
          <li className="top-buffer">
            ...
            <ul className="top-buffer">
              <li>
                <h4>
                  store.ts:{" "}
                  <small>Configured store to be used in router.tsx</small>
                </h4>
              </li>
            </ul>
          </li>
          <li className="top-buffer">
            ...
            <ul className="top-buffer">
              ...
              <li>
                <h4>
                  components/members/pageContainer.tsx:{" "}
                  <small>Create component using reducers state</small>
                </h4>
              </li>
              <li>
                <h4>
              ...
              <li>
                <h4>
                  components/member/pageContainer.tsx:{" "}
                  <small>Updated component using reducers state</small>
                </h4>
              </li>
              <li>
                <h4>
